...
(function installStorePreviewMocks() {
  ...
  const groupMetadata = new Map([
    [1, { title: "Work", color: "blue", collapsed: false }],
    [2, { title: "Research", color: "green", collapsed: false }],
    [3, { title: "Reading List", color: "yellow", collapsed: false }]
  ]);
  ...
  const windows = [
    {
      ...
      tabs: [
        ...
        createTab(3, 101, 2, {
          groupId: 2,
          title: "Chrome Web Store Listing Checklist",
    ...
    },
    {
      ...
      tabs: [
        ...
        createTab(6, 202, 1, {
          ...
          url: "https://figma.com/file/copy-review",
          faviconLabel: "F",
          faviconColor: "#a855f7"
        }),
        createTab(7, 202, 2, {
  ...
  const recentSessions = [
    {
      tab: {
        ...
        favIconUrl: createSvgDataUrl("D", "#8b5cf6")
      }
    },
    {
      tab: {
  ...
  function getAllTabs() {
    return cloneWindows().flatMap((windowInfo) => windowInfo.tabs);
  }
  ...
  const api = {
    runtime: {
      getURL(path) {
        if (path === "/_favicon/") {
          return "chrome-extension://store-preview/_favicon/";
        }
